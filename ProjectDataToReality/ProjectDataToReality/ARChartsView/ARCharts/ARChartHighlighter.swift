...
struct ARChartHighlighter {
    ...
    var highlightedSeries: Int?
    var highlightedIndex: Int?
    
    private let defaultFadedOpacity: Float = 0.15
    
    init(animationStyle: AnimationStyle, animationDuration: TimeInterval) {
     ...
     */
    mutating func highlight(_ barChart: ARBarChart, atIndex index: Int?, forSeries series: Int?) {
     ...
     */
    mutating func unhighlight(_ barChart: ARBarChart) {
